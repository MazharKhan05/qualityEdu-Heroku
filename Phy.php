...
include('connect.php');
    ...
    $status=$database->safeRetrieve($query,NUll);
     echo"<center>";   echo"<table class='table table-hover table-bordered' id='data'>";
                 echo"<thead class='thead-dark'><th>Book Id</th><th>Book Name</th><th>Book Author</th><th>Category</th><th>Book Pdf</th></thead>";
