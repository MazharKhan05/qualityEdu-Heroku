...
<body>
    <script>
        function total(){
            ...
            var sub5 = parseInt(document.getElementById("g5").value);
            var sub6 = parseInt(document.getElementById("g6").value);
            var sub7 = parseInt(document.getElementById("g7").value);
            var sub8 = parseInt(document.getElementById("g8").value);
        
            var totol=sub1+sub2+sub3+sub4+sub5+sub6+sub7+sub8;
            var ave=totol/8;
            var percent=ave*9.5;
        ...
        <div class="row">
            ...
            <thead class="thead-dark">
                  ...
                  <tr>
                      ...
                      <td><input type="text" class="form-control" name="g5" id="g5" placeholder="Enter your Sem5 Grade"></td>
                  </tr>
                  </div>
                  <div class="form-group">
                  <tr>
                      <td><b>Semester 6</b></td>
                      <td><input type="text" class="form-control" name="g6" id="g6" placeholder="Enter your Sem6 Grade"></td>
                  </tr>
                  </div>
                  <div class="form-group">
                  <tr>
                      <td><b>Semester 7</b></td>
                      <td><input type="text" class="form-control" name="g7" id="g7" placeholder="Enter your Sem7 Grade"></td>
                  </tr>
                  </div>
                  <div class="form-group">
                  <tr>
                      <td><b>Semester 8</b></td>
                      <td><input type="text" class="form-control" name="g8" id="g8" placeholder="Enter your Sem8 Grade"></td>
                  </tr>
                  </div>
                  ...
                  <tr>
                  <div class="form-group">
                      <td colspan="2"><center><button type="button" class="btn btn-success" onclick="total()">Average </button></center></td>
                      </div>
                  </tr>
