  ...
  <main id="main">
    ...
    <section id="pricing" class="pricing">
      <div class="container" data-aos="fade-up">
        ...
        <h1><center>Select No Of Semester</center></h1>
        <br>
        <tr>
        <center>
                    <td><a href="grd2.php" class="btn btn-info"  style="width: 20rem;">2 Semester</a></td>
                    </center>
           ...
           <br>
           <center>
                    <td><a href="grd4.php" class="btn btn-info"  style="width: 20rem;">4 Semester</a></td>
                    </center>
                    </tr>
                <tr>
                <br>
           <center>
                    <td><a href="grd6.php" class="btn btn-info" style="width: 20rem;">6 Semester</a></td>
                    </center>
                    </tr>
                <tr>
                <br>
           <center>
                    <td><a href="grd8.php" class="btn btn-info" style="width: 20rem;">8 Semester</a></td>
                    </center>
                    </tr>
