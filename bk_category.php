...
<body>
  ...
  <main id="main">
    ...
    <div class="question__head">
      ...
      <h2 style="text-align:center;" class="btn-dark"><center> Select Book Category</Select></center></h2><br>
    </div>

    <div class="row">
      <div class="col-md-4">
        <div class="card" style="width: 18rem;height:12rem;text-align:center;">
          <div class="card-body">
            <h4 class="card-title">Technical</h4>
            <p class="card-text"></p>
            <a href="Tech.php" class="btn btn-warning">Explore More</a>
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="card" style="width: 18rem;height:12rem;text-align:center;">
          <div class="card-body">
            ...
            <p class="card-text"></p>
            <a href="biog.php" class="btn btn-warning">Explore More</a>
          </div>
        </div>
        <br>
      </div>
      ...
      <div class="col-md-4">
        <div class="card" style="width: 18rem;height:12rem;text-align:center;">
          <div class="card-body">
            ...
            <p class="card-text"></p>
            <a href="Comi.php" class="btn btn-warning">Explore More</a>
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="card" style="width: 18rem;height:12rem;text-align:center;">
          <div class="card-body">
            ...
            <p class="card-text"></p>
            <a href="Social.php" class="btn btn-warning">Explore More</a>
          </div>
        </div>
      ...
      <div class="col-md-4">
        <div class="card" style="width: 18rem;height:12rem;text-align:center;">
          <div class="card-body">
            ...
            <p class="card-text"></p>
            <a href="Eng.php" class="btn btn-warning">Explore More</a>
          </div>
        </div>
