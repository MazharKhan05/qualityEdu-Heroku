...
<div class="modal__head"><i class="bi bi-journal-check"></i><h3>Modal Answer sheet sem-3</h3></div>

<table class="data__table table table-hover table-bordered table-striped">
...
<div class="page__change">
  <ul class="pagination">
    ...
    <li class="page-item"><a class="page-link" href="moans1.php">1</a></li>
    <li class="page-item"><a class="page-link" href="moans2.php">2</a></li>
    <li class="page-item"><a class="page-link" href="moans3.php">3</a></li>
    <li class="page-item">
